...
@section('content')
    <div class="container my-5">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">Информация вользователя</div>
                    <div class="card-body">
                        <div class="row py-4">
                            ...
                            <div class="col-12 justify-content-around d-flex pt-3">
                                <a href="{{ route('user.edit', $user->id) }}" class="btn btn-success text-white">Сменить пароль</a>
                                <a href="{{ route('user.edit', $user->id) }}" class="btn btn-success text-white">Сменить данные</a>
                                <a href="{{ route('forum.post.index') }}" class="btn btn-success text-white">Мои темы</a>
                            </div>
                        </div>
                    </div>
                </div>
